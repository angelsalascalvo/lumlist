...
public class StudentController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		switch(action) {
			...
			// ACTUALIZACI�N DE LOS DATOS DE UN ALUMNO EN LA BASE DE DATOS
			case "update":
				...
				if(session.getAttribute("admin") != null || (st!=null && st.getId()==sId)) {
					...
					//Observaciones
					 ...
					 if(req.getPart("curriculum").getSize()!=0){
				 	    ...
				 	    String fileName = getSubmittedFileName(curriculum);
					 ...
					 if(req.getPart("photo").getSize()!=0){
                                            Part photo = req.getPart("photo"); // Obtener el archivo		 
					 ...
					 //Actualizar la contrasenna si se ha cambiado
	...
	public void saveUploadFile(File fileOutput, InputStream in) {
        ...
        /**
         * OBTENER EL NOMBRE DE UN ARCHIVO ADJUNTO A UN FORMULARIO HTML
         * @param part
         * @return 
         */
