                	...
                	<div id="photoContainer" class="col100">
	                	...
	                	<c:choose>
						  <c:when test="${existPhoto}">
	                       	<img id="imageProfile" class="col100" src="uploads/${student.id}.jpg?dummy=<%= Math.random() %>">
						  </c:when>
						  <c:otherwise>
            ...
            <div id="cvSection" class="col45 row100">
                ...
                <c:choose>
				  <c:when test="${existCurri}">
                      	 <embed class="mMarginTop"src='uploads/${student.id}.pdf?dummy=<%= Math.random() %>' width='100%' height='90%' alt='pdf' pluginspage='http://www.adobe.com/products/acrobat/readstep2.html'>
				  </c:when>
				  <c:otherwise>
